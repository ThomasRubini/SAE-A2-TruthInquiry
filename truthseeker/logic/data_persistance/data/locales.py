...
LOCALES = [
    ...
    Locale(6,"FR","J’appréciais l’ameublement dans {SALLE}."),
    Locale(7,"FR","Avez-vous vu la magnifique collection exposé dans {SALLE}."),
    Locale(8,"FR","Je présentais la demeure à {NPC}."),
    Locale(9,"FR","Nous discutions avec {NPC} de l’histoire de la région"),
    ...
    Locale(46,"FR","{SALLE} me semblais un bon endroit pour me poser"),
    Locale(47,"FR","{SALLE} me rappelais mes voyages."),
    Locale(48,"FR","Nous organisions notre prochain voyage avec {NPC}."),
    Locale(49,"FR","Avec {NPC} on parler des lieux que l’on avait visité. C’était très instructif."),
